...
"")
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 414, 503))
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 414, 503))
        ...
        self.page_5.setGeometry(QtCore.QRect(0, 0, 414, 503))
        ...
        self.page_6.setGeometry(QtCore.QRect(0, 0, 414, 503))
        ...
        self.page_7.setGeometry(QtCore.QRect(0, 0, 414, 503))
        ...
        self.page_8.setGeometry(QtCore.QRect(0, 0, 414, 503))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Case Management"))
        self.pushButton_3.setText(_translate("MainWindow", "User Management"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("MainWindow", "Computer Investigation"))
        self.pushButton_4.setText(_translate("MainWindow", "Volatile Data"))
        self.pushButton_5.setText(_translate("MainWindow", "Non-volatile Data"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("MainWindow", "Data Collection"))
        self.pushButton_6.setText(_translate("MainWindow", "Memory Analysis"))
        self.pushButton_7.setText(_translate("MainWindow", "Registry Analysis"))
        self.pushButton_8.setText(_translate("MainWindow", "Browser Analysis"))
        self.pushButton_9.setText(_translate("MainWindow", "File System Analysis"))
        self.pushButton_10.setText(_translate("MainWindow", "Metadata Analysis"))
        self.pushButton_11.setText(_translate("MainWindow", "Event Log Analysis"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), _translate("MainWindow", "Data Analysis"))
        self.pushButton_14.setText(_translate("MainWindow", "Generate Report"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_6), _translate("MainWindow", "Reports"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_7), _translate("MainWindow", "System Settings"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_8), _translate("MainWindow", "Logout"))
