...
class Ui_AddEvidenceWizard(object):
    def setupUi(self, AddEvidenceWizard):
        ...
        self.descriptionLabel = QtWidgets.QLabel("Choose how you want to add evidence to the case.")
        ...
        self.volatileTypeRadio = QtWidgets.QRadioButton("Volatile Data (Memory, Network, Processes, ...)")
        self.volatileTypeRadio.setChecked(True)
        self.volatileTypeRadio.setStyleSheet("font-size: 14px; padding: 10px;")
        
        self.nonvolatileTypeRadio = QtWidgets.QRadioButton("Non-volatile Data (Disk, Files, Registry, ...)")
        ...
        self.nonvolatileStatusLabel = QtWidgets.QLabel("🔵 Ready to collect non-volatile data")
        ...
        self.startNonvolatileBtn = QtWidgets.QPushButton("🚀 Start Non-volatile Collection")
